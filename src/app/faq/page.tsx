...
const faqData: FAQItem[] = [
  // 予約関連
  {
    ...
    answer: 'お電話（090-4695-3087）、LINE、Webフォームからご予約いただけます。電話予約が最も確実です。予約時には、ご希望の日時（第1便または第2便）、参加人数、竿レンタルの有無をお伝えください。',
  ...
  },
  {
    category: '予約について',
    question: '当日予約は可能ですか？',
    answer: '空席があれば当日予約も可能です。お電話（090-4695-3087）でお問い合わせください。ただし、事前予約をおすすめします。',
    keywords: ['当日', '予約', '空席'],
  },
  ...
  // 料金関連
  {
    category: '料金について',
    question: '料金はいくらですか？',
    answer: '乗船料は1名様11,000円（税込）です。竿レンタルをご希望の場合は、1本2,000円でご用意しております。エサ・仕掛けは料金に含まれています。',
  ...
  },
  {
    ...
    answer: '竿のレンタルは1本2,000円でご用意しております。仕掛けやエサは料金に含まれています。初心者の方にはレンタルをおすすめします。',
